...
public class ArcadeManaoTest {
    ...
    @Test
    public void test10() {
        String[] param0 = new String[]{"XXXX....", "...X.XXX", "XXX..X..", "......X.", "XXXXXXXX"};
        int param1 = 2;
        int param2 = 4;
        assertEquals(2, new ArcadeManao().shortestLadder(param0, param1, param2));
    }

    @Test
    public void test11() {
        String[] param0 = new String[]{"XXXX", "...X", "XXXX"};
        int param1 = 1;
        int param2 = 1;
        assertEquals(1, new ArcadeManao().shortestLadder(param0, param1, param2));
    }
